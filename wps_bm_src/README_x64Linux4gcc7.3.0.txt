...
data type DDS_BuildModelReportMessage from buildmodel.idl.
This example builds two applications, named buildmodel_publisher and
buildmodel_subscriber.

To Build this example:
======================
 
From your command shell, type:
> make -f makefile_buildmodel_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_buildmodel_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the buildmodel_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/buildmodel_publisher <domain_id> <sample_count>
> objs/x64Linux4gcc7.3.0/buildmodel_subscriber <domain_id> <sample_count>
